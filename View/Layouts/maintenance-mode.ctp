...
<html lang="en">
  <head>
    ...
    <style>
      ...
      .contact-info {
        padding: 2.5em 0; /* 30/12 */ 
        border-top: 1px solid #ddd; 
        border-bottom: 1px solid #ddd;
      }

      footer {
        padding: 2.5em 0 0; /* 30/12 */ 
        font-size: .75em;
      }
  ...
  <body>   
    <div class="wrapper">    
      ...
      <div class="contact-info">
        <p><strong><?php echo $this->Settings->show('Site.name'); ?></strong><br><?php echo $this->Settings->show('Site.Contact.address'); ?><span></span><?php echo $this->Settings->show('Site.Contact.city'); ?>, <?php echo $this->Settings->show('Site.Contact.province_state'); ?> <?php echo $this->Settings->show('Site.Contact.postal_zip'); ?><br>
          <?php
      ...
      <footer>    
        Copyright &copy; <?php echo $this->Copyright->year(); ?> <?php echo $this->Copyright->name(); ?> <span></span> A website by <?php echo $this->Html->link('Radar Hill Web Design', 'http://www.radarhill.com', array('target' => '_blank', 'title' => 'www.radarhill.com')); ?> <span></span> The content of this website is the responsibility of the website owner.
      </footer> 
    </div> 
    <?php 
